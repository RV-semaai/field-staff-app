...
import com.semaai.agent.databinding.ActivityMyTargetBinding;
...
import com.semaai.agent.viewmodel.targettracking.MyTargetViewModel;
...
public class MyTargetActivity extends AppCompatActivity implements OnItemClickListenerYear , OnItemClickListenerMonth {

    private static final String TAG = MyTargetActivity.class.getSimpleName()+"-->";
    private MyTargetListAdapter myTargetListAdapter;
    private MyTargetViewModel myTargetViewModel;
    private ActivityMyTargetBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTargetViewModel = ViewModelProviders.of(this).get(MyTargetViewModel.class);
        binding = DataBindingUtil.setContentView(MyTargetActivity.this,R.layout.activity_my_target);
        binding.setLifecycleOwner(this);
        binding.setMyTargetViewModel(myTargetViewModel);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (response.has("error")) {
                            progressdilogset(MyTargetActivity.this);
                        ...
                        try {
                            ...
                            if (challenges.length()== 0 || goals_desc.length() == 0){
                                ToastMsg.showToast(MyTargetActivity.this,getString(R.string.errorMessage));
                            }
                            Log.i(TAG,"challenge data not found" +challenges.length());
                            ...
                            myTargetListAdapter = new MyTargetListAdapter( MyTargetActivity.this , challengeListModels , goalsDescListModels );
    ...
    private void onClick() {
        ...
        binding.clTitle.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.rlRegister.ivBackArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MyTargetActivity.this, TargetTrackingDashboardActivity.class));
            }
        });
        binding.cmBottom.clAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MyTargetActivity.this, AccountDashboardActivity.class));
            }
        });
        binding.cmBottom.clHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MyTargetActivity.this,DashboardActivity.class));
            }
        });
        ...
        binding.tvLastMonth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                refreshMonth = -1;
                refreshYear = 0;
                binding.tvMyTargetDate.setText(getString(R.string.lastMonth));
        ...
        binding.ivMyRefresh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void monthList() {
        ...
        adaptor = new MonthListAdaptor(list,MyTargetActivity.this,MyTargetActivity.this , months);
        binding.commomMonthYear.rvMonthList.setLayoutManager(new LinearLayoutManager(MyTargetActivity.this));
    ...
    private void yearList() {
        ...
        yearAdaptor = new YearListAdapter(yearList,MyTargetActivity.this,MyTargetActivity.this, years);
        binding.commomMonthYear.rvYearList.setHasFixedSize(true);
        binding.commomMonthYear.rvYearList.setLayoutManager(new LinearLayoutManager(MyTargetActivity.this));
