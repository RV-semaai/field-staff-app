...
public class VillageAdaptor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    List<RVItemModel> rvItemModelList;
    OnItemClickListener onItemClickListener;
    String TAG = VillageAdaptor.class.getSimpleName() + "-->";
    int check;


    public VillageAdaptor(List<RVItemModel> rvItemModelList, OnItemClickListener onItemClickListener, int check) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == 0) {
            ...
            return new VillageViewHolder(rvDropdownListBinding);
        } else if (viewType == 1){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (getItemViewType(position) == 0) {
            VillageViewHolder viewHolder = (VillageViewHolder) holder;
            ...
            viewHolder.rvDropdownListBinding.tvListText.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    onItemClickListener.onItemClick("village", rvItemModelList.get(position), 0);
                }
            });
            ...
            viewHolder.rvFilterDropDownListBinding.tvListText.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.i(TAG, "data" + rvItemModelList.get(position));
                    onItemClickListener.onItemClick("village", rvItemModelList.get(position), 1);
//                    viewHolder.rvfilterdropdoenlistBinding.tvListtext.setTextColor(Color.BLACK);
    ...
    public class VillageViewHolder extends RecyclerView.ViewHolder {
        ...
        public VillageViewHolder(ItemRvDropDownListBinding rvDropdownListBinding) {
