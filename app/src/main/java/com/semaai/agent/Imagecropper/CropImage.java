...
public final class CropImage {
    ...
    /**
     * Create {@link ActivityBuilder} instance to start { CropImageActivity} to crop the given
     * image.<br>
     * Result will be received in { Activity#onActivityResult(int, int, Intent)} and can be
     * retrieved using {@link #getActivityResult(Intent)}.
     *
    ...
    /**
     * Get { CropImageActivity} result data object for crop image activity started using {@link
     * #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * the title of the { CropImageActivity}.<br>
         * <i>Default: ""</i>
         */
