...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        mCropOverlayView = v.findViewById(R.id.ol_cropOverlayView);
        ...
        mProgressBar = v.findViewById(R.id.pb_cropProgressBar);
     ...
     * Set shape
     */
    public void setCropImageViewShape(Bitmap shape) {
        mCropOverlayView.setCropOverlayViewShape(shape);
    }
